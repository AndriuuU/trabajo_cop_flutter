...
class GraficaScreen extends StatefulWidget  {
  ...
  @override
  State<GraficaScreen> createState() => _GraphsScreenState();
}
//   @override
...
//             onPressed: () => Navigator.pushReplacementNamed(context, 'gestion'),
...
class _GraphsScreenState extends State<GraficaScreen> {
